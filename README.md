# rss_ringoccs
rss_ringoccs is a suite of Python-based analysis tools for Cassini Radio Science (RSS) ring occultations. It was developed at Wellesley College under the direction of Richard French (Cassini RSS Team Leader) by Research Assistantes Jolene Fong Ryan Maguire, and Jolene Fong, with funding provided by the NASA/JPL Cassini project.
