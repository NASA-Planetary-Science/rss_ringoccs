...
freq_offset_file = '../output/Rev7E/freq_offset.txt'
geo_file = '../output/Rev7E/RSS_2005_123_X43_E_GEO.TAB'
cal_file = '../output/Rev7E/RSS_2005_123_X43_E_CAL.TAB'
dlp_file = '../output/Rev7E/RSS_2005_123_X43_E_DLP.TAB'
...
fit_inst = FreqOffsetFit(rsr_inst, geo_inst, f_spm, f_offset,
    f_uso, kernels, k=k_f_resid, spm_include=spm_include)
...
spm_power_fit, power_spline_fit = norm_inst.get_spline_fit(
    freespace_spm=freespace_spm, k=k_power)
...
make_dlp_file(dlp_file, norm_diff_inst)
pdb.set_trace()
