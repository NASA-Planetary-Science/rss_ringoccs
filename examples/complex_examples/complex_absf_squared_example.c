...
int main(void)
{
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CFloat_Abs_Squared(z[n]);
 ...
 *                                                                            *
 *      gcc complex_absf_squared_example.c -o test -lrssringoccs              *
 *                                                                            *
 ...
 *              complex_absf_squared_example.c -o test -lrssringoccs          *
 *                                                                            *
 ...
 *          -Wpedantic complex_absf_squared_example.c -o test -lrssringoccs   *
 *                                                                            *
