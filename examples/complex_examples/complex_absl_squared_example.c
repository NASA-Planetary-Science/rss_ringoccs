 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides an example of using the long double precision complex abs    *
 *      squared function.                                                     *
 ******************************************************************************
...
int main(void)
{
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CLDouble_Abs_Squared(z[n]);
 ...
 *                                                                            *
 *      gcc complex_absl_squared_example.c -o test -lrssringoccs              *
 *                                                                            *
 ...
 *              complex_absl_squared_example.c -o test -lrssringoccs          *
 *                                                                            *
 ...
 *          -Wpedantic complex_absl_squared_example.c -o test -lrssringoccs   *
 *                                                                            *
