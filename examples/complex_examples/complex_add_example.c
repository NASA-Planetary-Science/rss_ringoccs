...
int main(void)
{
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CDouble_Add(z0[n], z1[n]);
 ...
 *                                                                            *
 *      gcc complex_add_example.c -o test -lrssringoccs                       *
 *                                                                            *
 ...
 *              complex_add_example.c -o test -lrssringoccs                   *
 *                                                                            *
 ...
 *          -Wpedantic complex_add_example.c -o test -lrssringoccs            *
 *                                                                            *
