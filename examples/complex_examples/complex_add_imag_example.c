...
int main(void)
{
    ...
    rssringoccs_ComplexDouble z[7], w[7];
    double y[7];
    ...
    y[0] =  rssringoccs_Infinity;
    y[1] =  rssringoccs_NaN;
    y[2] = -4.0;
    y[3] =  1.0;
    y[4] =  2.0;
    y[5] =  1.0;
    y[6] =  -rssringoccs_Infinity;

    /*  Loop over the results and print them.                                 */
    for (n=0; n<7; ++n)
    {
        /*  Compute z + iy of the nth value.                                  */
        w[n] = rssringoccs_CDouble_Add_Imag(y[n], z[n]);
 ...
 *                                                                            *
 *      gcc complex_add_imag_example.c -o test -lrssringoccs                  *
 *                                                                            *
 ...
 *              complex_add_imag_example.c -o test -lrssringoccs              *
 *                                                                            *
 ...
 *          -Wpedantic complex_add_imag_example.c -o test -lrssringoccs       *
 *                                                                            *
