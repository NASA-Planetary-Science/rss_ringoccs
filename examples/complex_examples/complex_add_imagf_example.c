...
int main(void)
{
    ...
    y[0] =  rssringoccs_Infinity_F;
    y[1] =  rssringoccs_NaN_F;
    y[2] = -4.0F;
    y[3] =  1.0F;
    y[4] =  2.0F;
    y[5] =  1.0F;
    y[6] =  -rssringoccs_Infinity_F;

    /*  Loop over the results and print them.                                 */
    for (n=0; n<7; ++n)
    {
        /*  Compute z + iy of the nth value.                                  */
        w[n] = rssringoccs_CFloat_Add_Imag(y[n], z[n]);
 ...
 *                                                                            *
 *      gcc complex_add_imagf_example.c -o test -lrssringoccs                 *
 *                                                                            *
 ...
 *              complex_add_imagf_example.c -o test -lrssringoccs             *
 *                                                                            *
 ...
 *          -Wpedantic complex_add_imagf_example.c -o test -lrssringoccs      *
 *                                                                            *
