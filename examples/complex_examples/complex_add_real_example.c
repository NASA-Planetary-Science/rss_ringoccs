...
int main(void)
{
    ...
    x[0] =  rssringoccs_Infinity;
    x[1] =  rssringoccs_NaN;
    x[2] = -4.0;
    x[3] =  1.0;
    x[4] =  2.0;
    x[5] =  1.0;
    x[6] =  -rssringoccs_Infinity;

    /*  Loop over the results and print them.                                 */
    for (n=0; n<7; ++n)
    {
        /*  Compute z + x of the nth value.                                   */
        w[n] = rssringoccs_CDouble_Add_Real(x[n], z[n]);
 ...
 *                                                                            *
 *      gcc complex_add_real_example.c -o test -lrssringoccs                  *
 *                                                                            *
 ...
 *              complex_add_real_example.c -o test -lrssringoccs              *
 *                                                                            *
 ...
 *          -Wpedantic complex_add_real_example.c -o test -lrssringoccs       *
 *                                                                            *
