...
int main(void)
{
    ...
    x[0] =  rssringoccs_Infinity_L;
    x[1] =  rssringoccs_NaN_L;
    x[2] = -4.0L;
    x[3] =  1.0L;
    x[4] =  2.0L;
    x[5] =  1.0L;
    x[6] =  -rssringoccs_Infinity_L;

    /*  Loop over the results and print them.                                 */
    for (n=0; n<7; ++n)
    {
        /*  Compute z + x of the nth value.                                   */
        w[n] = rssringoccs_CLDouble_Add_Real(x[n], z[n]);
 ...
 *                                                                            *
 *      gcc complex_add_reall_example.c -o test -lrssringoccs                 *
 *                                                                            *
 ...
 *              complex_add_reall_example.c -o test -lrssringoccs             *
 *                                                                            *
 ...
 *          -Wpedantic complex_add_reall_example.c -o test -lrssringoccs      *
 *                                                                            *
