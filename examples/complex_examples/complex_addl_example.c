...
int main(void)
{
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CLDouble_Add(z0[n], z1[n]);
 ...
 *                                                                            *
 *      gcc complex_addl_example.c -o test -lrssringoccs                      *
 *                                                                            *
 ...
 *              complex_addl_example.c -o test -lrssringoccs                  *
 *                                                                            *
 ...
 *          -Wpedantic complex_addl_example.c -o test -lrssringoccs           *
 *                                                                            *
