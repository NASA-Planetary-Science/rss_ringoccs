...
int main(void)
{
    ...
    rssringoccs_ComplexDouble z0[9], z1[9];
    ...
    z0[3] = rssringoccs_CDouble_I;
    z0[4] = rssringoccs_CDouble_Rect(-1.0, 1.0);
    z0[5] = rssringoccs_CDouble_Rect(-1.0, 0.0);
    z0[6] = rssringoccs_CDouble_Rect(-1.0, -1.0);
    z0[7] = rssringoccs_CDouble_Rect(0.0, -1.0);
    z0[8] = rssringoccs_CDouble_Rect(1.0, -1.0);

    /*  Set the test values in the array z1.                                  */
    z1[0] = rssringoccs_CDouble_Zero;
    z1[1] = rssringoccs_CDouble_Rect(1.0, 1.0);
    z1[2] = rssringoccs_CDouble_One;
    z1[3] = rssringoccs_CDouble_I;
    z1[4] = rssringoccs_CDouble_Rect(-1.0, 0.0);
    z1[5] = rssringoccs_CDouble_Rect(-1.0, 1.0);
    z1[6] = rssringoccs_CDouble_Rect(-1.0, -1.0);
    z1[7] = rssringoccs_CDouble_Rect(1.0, -1.0);
    z1[8] = rssringoccs_CDouble_Rect(0.0, -1.0);
    ...
    for (n=0; n<9; ++n)
    {
        ...
        if (rssringoccs_CDouble_Compare(z0[n], z1[n]))
 ...
 *                                                                            *
 *      gcc complex_compare_example.c -o test -lrssringoccs                   *
 *                                                                            *
 ...
 *              complex_compare_example.c -o test -lrssringoccs               *
 *                                                                            *
 ...
 *          -Wpedantic complex_compare_example.c -o test -lrssringoccs        *
 *                                                                            *
