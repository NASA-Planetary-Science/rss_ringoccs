...
int main(void)
{
    ...
    rssringoccs_ComplexLongDouble z0[9], z1[9];
    ...
    z0[3] = rssringoccs_CLDouble_I;
    z0[4] = rssringoccs_CLDouble_Rect(-1.0L, 1.0L);
    z0[5] = rssringoccs_CLDouble_Rect(-1.0L, 0.0L);
    z0[6] = rssringoccs_CLDouble_Rect(-1.0L, -1.0L);
    z0[7] = rssringoccs_CLDouble_Rect(0.0L, -1.0L);
    z0[8] = rssringoccs_CLDouble_Rect(1.0L, -1.0L);

    /*  Set the test values in the array z1.                                  */
    z1[0] = rssringoccs_CLDouble_Zero;
    z1[1] = rssringoccs_CLDouble_Rect(1.0L, 1.0L);
    z1[2] = rssringoccs_CLDouble_One;
    z1[3] = rssringoccs_CLDouble_I;
    z1[4] = rssringoccs_CLDouble_Rect(-1.0L, 0.0L);
    z1[5] = rssringoccs_CLDouble_Rect(-1.0L, 1.0L);
    z1[6] = rssringoccs_CLDouble_Rect(-1.0L, -1.0L);
    z1[7] = rssringoccs_CLDouble_Rect(1.0L, -1.0L);
    z1[8] = rssringoccs_CLDouble_Rect(0.0L, -1.0L);
    ...
    for (n=0; n<9; ++n)
    {
        ...
        if (rssringoccs_CLDouble_Compare(z0[n], z1[n]))
 ...
 *                                                                            *
 *      gcc complex_comparel_example.c -o test -lrssringoccs                  *
 *                                                                            *
 ...
 *              complex_comparel_example.c -o test -lrssringoccs              *
 *                                                                            *
 ...
 *          -Wpedantic complex_comparel_example.c -o test -lrssringoccs       *
 *                                                                            *
