...
int main(void)
{
    ...
    z[2] = rssringoccs_CDouble_I;
    z[3] = rssringoccs_CDouble_Rect(1.0, 1.0);
    z[4] = rssringoccs_CDouble_NaN;
    z[5] = rssringoccs_CDouble_Infinity;

    /*  Loop over the results and print them.                                 */
    for (n=0; n<6; ++n)
    {
        /*  Compute the complex conjugate of the nth value.                   */
        w[n] = rssringoccs_CDouble_Conjugate(z[n]);
 ...
 *                                                                            *
 *      gcc complex_conjugate_example.c -o test -lrssringoccs                 *
 *                                                                            *
 ...
 *              complex_conjugate_example.c -o test -lrssringoccs             *
 *                                                                            *
 ...
 *          -Wpedantic complex_conjugate_example.c -o test -lrssringoccs      *
 *                                                                            *
