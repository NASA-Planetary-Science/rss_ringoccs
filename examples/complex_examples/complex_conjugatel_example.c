...
int main(void)
{
    ...
    z[2] = rssringoccs_CLDouble_I;
    z[3] = rssringoccs_CLDouble_Rect(1.0L, 1.0L);
    z[4] = rssringoccs_CLDouble_NaN;
    z[5] = rssringoccs_CLDouble_Infinity;

    /*  Loop over the results and print them.                                 */
    for (n=0; n<6; ++n)
    {
        /*  Compute the complex conjugate of the nth value.                   */
        w[n] = rssringoccs_CLDouble_Conjugate(z[n]);
 ...
 *                                                                            *
 *      gcc complex_conjugatel_example.c -o test -lrssringoccs                *
 *                                                                            *
 ...
 *              complex_conjugatel_example.c -o test -lrssringoccs            *
 *                                                                            *
 ...
 *          -Wpedantic complex_conjugatel_example.c -o test -lrssringoccs     *
 *                                                                            *
