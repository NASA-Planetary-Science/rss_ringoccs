...
int main(void)
{
    ...
    z[1] = rssringoccs_CFloat_Rect(0.0F, rssringoccs_One_Pi_F);
    z[2] = rssringoccs_CFloat_Rect(rssringoccs_One_Pi_F, 0.0F);
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CFloat_Cos(z[n]);
 ...
 *                                                                            *
 *      gcc complex_cosf_example.c -o test -lrssringoccs                      *
 *                                                                            *
 ...
 *              complex_cosf_example.c -o test -lrssringoccs                  *
 *                                                                            *
 ...
 *          -Wpedantic complex_cosf_example.c -o test -lrssringoccs           *
 *                                                                            *
