...
int main(void)
{
    ...
    rssringoccs_ComplexDouble z0[7], z1[7];
    double w[7];
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CDouble_Dist(z0[n], z1[n]);
 ...
 *                                                                            *
 *      gcc complex_dist_example.c -o test -lrssringoccs                      *
 *                                                                            *
 ...
 *              complex_dist_example.c -o test -lrssringoccs                  *
 *                                                                            *
 ...
 *          -Wpedantic complex_dist_example.c -o test -lrssringoccs           *
 *                                                                            *
