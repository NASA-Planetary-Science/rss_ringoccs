...
int main(void)
{
    ...
    rssringoccs_ComplexFloat z0[7], z1[7];
    float w[7];
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CFloat_Dist(z0[n], z1[n]);
 ...
 *                                                                            *
 *      gcc complex_distf_example.c -o test -lrssringoccs                     *
 *                                                                            *
 ...
 *              complex_distf_example.c -o test -lrssringoccs                 *
 *                                                                            *
 ...
 *          -Wpedantic complex_distf_example.c -o test -lrssringoccs          *
 *                                                                            *
