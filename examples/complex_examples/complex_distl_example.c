...
int main(void)
{
    ...
    rssringoccs_ComplexLongDouble z0[7], z1[7];
    long double w[7];
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CLDouble_Dist(z0[n], z1[n]);
 ...
 *                                                                            *
 *      gcc complex_distl_example.c -o test -lrssringoccs                     *
 *                                                                            *
 ...
 *              complex_distl_example.c -o test -lrssringoccs                 *
 *                                                                            *
 ...
 *          -Wpedantic complex_distl_example.c -o test -lrssringoccs          *
 *                                                                            *
 *  Note, this should all be one line. This outputs an executable "test".     *
 *  Running the executable with ./test, this outputs:                         *
 *      |(0.000000 + i0.000000) - (1.000000 + i1.000000)| = 1.414214          *
 *      |(1.000000 + i0.000000) - (2.000000 + i0.000000)| = 1.000000          *
 *      |(1.000000 + i1.000000) - (1.000000 + i3.000000)| = 2.000000          *
 *      |(nan + i0.000000) - (1.000000 + i4.000000)| = nan                    *
 *      |(inf + i0.000000) - (1.000000 + i0.000000)| = inf                    *
 *      |(nan + inan) - (1.000000 + i8.000000)| = nan                         *
 *      |(inf + iinf) - (1.000000 + i1.000000)| = inf                         *
 ******************************************************************************/
