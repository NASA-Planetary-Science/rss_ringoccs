...
int main(void)
{
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CFloat_Divide(z0[n], z1[n]);
 ...
 *                                                                            *
 *      gcc complex_dividef_example.c -o test -lrssringoccs                   *
 *                                                                            *
 ...
 *              complex_dividef_example.c -o test -lrssringoccs               *
 *                                                                            *
 ...
 *          -Wpedantic complex_dividef_example.c -o test -lrssringoccs        *
 *                                                                            *
