...
int main(void)
{
    ...
    {
        z = rssringoccs_Complex_Rect(y_max, 0.0);
        max = rssringoccs_Complex_Abs(rssringoccs_Complex_Erf(z));
    }
    else
    {
        z = rssringoccs_Complex_Rect(y_min, 0.0);
        max = rssringoccs_Complex_Abs(rssringoccs_Complex_Erf(z));
    }
    ...
    /*  For complex erf, the minimum is just minus the maximum.               */
    min = -max;
