"""
Purpose:
    Example rss_ringoccs/ 'quick-look' process script.
"""
...
geo_file = data_dir + 'RSS_2005_123_X43_E_GEO_20190122_0001.TAB'
cal_file = data_dir + 'RSS_2005_123_X43_E_CAL_20190122_0001.TAB'
dlp_file = data_dir + 'RSS_2005_123_X43_E_DLP_0500M_20190122_0001.TAB'

verbose = True
inversion_range = 'all'
res_list = [2.0, 1.6, 1.0, 0.67]
...
nres = len(res_list)
fig, axes = plt.subplots(nres, 1, figsize=(8,8), sharex=True)
