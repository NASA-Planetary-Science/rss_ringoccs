...
################################################################################
#   Purpose:                                                                   #
#       Creates a LBL file for calibration data.                               #
################################################################################
#   Author: Jolene Fong                                                        #
#   Date:   2018/07/23                                                         #
################################################################################
    ...
    """
        ...
        Args:
            ...
            series_name (str):
                ...
                onto series_name
            prof_dir (str):
                Direction of ring occultation for this cal_inst
        Outputs:
            str_lbl (dict):
                Dictionary with keys:
                    string_delimiter, alignment_column,
                    series_alignment_column, keywords_value,
                    keywords_NAIF_TOOLKIT_VERSION, description,
                    keywords_series, object_keys, object_values, history
