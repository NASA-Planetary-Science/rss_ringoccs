...
float rssringoccs_ComplexFloat_Real_Part(rssringoccs_ComplexFloat z)
{
...
double rssringoccs_ComplexDouble_Real_Part(rssringoccs_ComplexDouble z)
{
    /*  Declare necessary variables. C89 requires declarations at the top.    */
    double real;
...
double rssringoccs_ComplexFloat_Real_Part(rssringoccs_ComplexFloat z)
{
    return crealf(z);
}
