...
type rssringoccs_##Type##_Kaiser_Bessel(type x, type W, type alpha)            \
{                                                                              \
    type kbmd, arg, abs_x;                                                     \
                                                                               \
    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            kbmd = rssringoccs_##Type##_Bessel_I0(alpha * arg) /               \
                   rssringoccs_##Type##_Bessel_I0(alpha);                      \
        }                                                                      \
        else                                                                   \
            kbmd = 0.0;                                                        \
    }                                                                          \
...
_define_kaiser_bessel(long double, LDouble)
