                                                           ...
                                                           void *closure)
{
    ...
    /*  Buffer for the diffracted phase data.                                 */
    double *diffracted_phase = NULL;
    ...
    /*  The real-valued phase_norm_deg_vals array is computed from the        *
    ...
    /*  Otherwise, compute the diffracted phase from the T_in array.          */
    diffracted_phase = TMPL_MALLOC(double, self->tau->n_used);
    ...
    crssringoccs_Create_Real_Numpy_Array(
        &self->phase_norm_deg_vals,     /*  The Python object.                */
        diffracted_phase,               /*  The real-valued C data.           */
    ...
    if (!self->phase_norm_deg_vals)
    {
        ...
        TMPL_FREE(self->phase_norm_deg_vals);
        return NULL;
    }
...
/*  End of crssringoccs_DiffractionCorrection_Get_Phase_Norm_Deg_Vals.        */
