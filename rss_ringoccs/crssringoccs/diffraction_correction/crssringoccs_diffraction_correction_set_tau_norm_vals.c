                                                     ...
                                                     void *closure)
{
    ...
    if (!op)
    {
        PyErr_Format(
            ...
            "\r\tcrssringoccs_DiffractionCorrection_Set_Tau_Norm_Vals\n\n"
            "\rInput 'op' is NULL.\n\n"
        );
    ...
    /*  Set tau_norm_vals to the input value. There are no checks for what    *
     *  type of object this is, the user is free to set it to anything.       */
    Py_XSETREF(self->tau_norm_vals, Py_XNewRef(value));
    return 0;
}
/*  End of crssringoccs_DiffractionCorrection_Set_Tau_Norm_Vals.              */
