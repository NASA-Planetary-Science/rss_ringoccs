                                 ...
                                 PyObject *kwds)
{
    ...
    /*  The list of the keywords accepted by the VoyagerCSVData class. The    *
     ...
     *  VoyagerCSVData, for example VoyagerCSVData(..., tau = "TAU.TAB").     *
    ...
    if (!csv)
    {
        PyErr_Format(
            ...
            "\n\rError Encountered: rss_ringoccs\n"
            "\r\tVoyagerCSVData\n\n"
            "\rrssringoccs_UranusCSVData_Extract returned NULL.\n"
        );
    ...
    if (csv->error_occurred)
    {
        PyErr_Format(
            ...
            "\n\rError Encountered: rss_ringoccs\n"
            "\r\tVoyagerCSVData\n\n"
            "\rrssringoccs_UranusCSVData_Extract returned with error_occurred\n"
