...
class diffraction_correction(object):
    ...
    def __trim_attributes(self,fwd):
        ...
        self.t_oet_spm_vals          = recdata.t_oet_spm_vals[crange]       
        self.t_ret_spm_vals          = recdata.t_ret_spm_vals[crange] 
        self.t_set_spm_vals          = recdata.t_set_spm_vals[crange] 
        self.rho_corr_pole_km_vals   = recdata.rho_corr_pole_km_vals[crange]    
        self.rho_corr_timing_km_vals = recdata.rho_corr_timing_km_vals[crange]
        self.phi_rl_rad_vals         = recdata.phi_rl_rad_vals[crange]
        if fwd:
