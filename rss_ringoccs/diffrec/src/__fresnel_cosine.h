...
double Fresnel_Cosine_Heald_Rational_EPS_Minus_Three_Func(double x)
{
...
double Fresnel_Cosine_Heald_Rational_EPS_Minus_Four_Func(double x)
{
    double A, R, a, b, c, d, sgn_x;
    sgn_x = (x>0)-(x<0);
    x *= SQRT_2_BY_PI*sgn_x;
...
double Fresnel_Cosine_Heald_Rational_EPS_Minus_Six_Func(double x)
{
    double A, R, a, b, c, d, sgn_x;
    sgn_x = (x>0)-(x<0);
    x *= SQRT_2_BY_PI*sgn_x;
...
double Fresnel_Cosine_Heald_Rational_EPS_Minus_Eight_Func(double x)
{
    double A, R, a, b, c, d, sgn_x;
    sgn_x = (x>0)-(x<0);
    x *= SQRT_2_BY_PI*sgn_x;
