...
float Ringlet_Diffraction_Phase_Float(float x, float a, float b, float F)
{
    ...
    im = SQRT_ONE_BY_2_PI *
        (Fresnel_Sine_Taylor_to_Asymptotic_Float(b)   -
         Fresnel_Sine_Taylor_to_Asymptotic_Float(a)   - 
         Fresnel_Cosine_Taylor_to_Asymptotic_Float(b) +
         Fresnel_Cosine_Taylor_to_Asymptotic_Float(a));
...
double Ringlet_Diffraction_Phase_Double(double x, double a, double b, double F)
{
    ...
    im = SQRT_ONE_BY_2_PI *
        (Fresnel_Sine_Taylor_to_Asymptotic_Double(b) -
         Fresnel_Sine_Taylor_to_Asymptotic_Double(a) - 
         Fresnel_Cosine_Taylor_to_Asymptotic_Double(b)   +
         Fresnel_Cosine_Taylor_to_Asymptotic_Double(a));
                                                  ...
                                                  long double b, long double F)
{
    ...
    im = SQRT_ONE_BY_2_PI *
        (Fresnel_Sine_Taylor_to_Asymptotic_Long_Double(b)   -
         Fresnel_Sine_Taylor_to_Asymptotic_Long_Double(a)   - 
         Fresnel_Cosine_Taylor_to_Asymptotic_Long_Double(b) +
         Fresnel_Cosine_Taylor_to_Asymptotic_Long_Double(a));
