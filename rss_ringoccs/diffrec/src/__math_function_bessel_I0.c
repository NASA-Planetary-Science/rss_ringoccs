...
double BesselI0_Char(char x)            {return BesselI0_Double((double) x);}
double BesselI0_UChar(unsigned char x)  {return BesselI0_Double((double) x);}
double BesselI0_Short(short x)          {return BesselI0_Double((double) x);}
double BesselI0_UShort(unsigned short x){return BesselI0_Double((double) x);}
double BesselI0_Int(int x)              {return BesselI0_Double((double) x);}
double BesselI0_UInt(unsigned int x)    {return BesselI0_Double((double) x);}
double BesselI0_Long(long x)            {return BesselI0_Double((double) x);}
double BesselI0_ULong(unsigned long x)  {return BesselI0_Double((double) x);}
double BesselI0_Long_Long(long long x)  {return BesselI0_Double((double) x);}

double BesselI0_ULong_Long(unsigned long long x)
{
    return BesselI0_Double((double) x);
}