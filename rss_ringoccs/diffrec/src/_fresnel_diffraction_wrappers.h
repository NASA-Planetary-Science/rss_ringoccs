...
static void float_right_straightedge(char **args, npy_intp *dimensions,
                                      npy_intp* steps, void* data){
    long i;
    long n = dimensions[0];
    ...
    for (i = 0; i < n; i++) {
        out[i] = Right_Straightedge_Diffraction_Float(x[i], edge, F);
    }
}

static void double_right_straightedge(char **args, npy_intp *dimensions,
                                       npy_intp* steps, void* data){
    long i;
    long n = dimensions[0];
    ...
    for (i = 0; i < n; i++) {
        out[i] = Right_Straightedge_Diffraction_Double(x[i], edge, F);
    }
}

static void long_double_right_straightedge(char **args, npy_intp *dimensions,
                                           npy_intp* steps, void* data){
    long i;
    long n = dimensions[0];
