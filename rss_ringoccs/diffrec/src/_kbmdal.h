...
#ifndef RSS_RINGOCCS__KBMDAL_H
#define RSS_RINGOCCS__KBMDAL_H
...
static PyObject *kbmdal(PyObject *self, PyObject *args)
{
    ...
    else
    {
        ...
        {
            __get_one_real_from_three_real(((unsigned char *)data), dx,
                                           alpha, y, dim,
        ...
        {
            __get_one_real_from_three_real(((unsigned short *)data), dx,
                                           alpha, y, dim,
        ...
        {
            __get_one_real_from_three_real(((unsigned long *)data), dx,
                                           alpha, y, dim,
