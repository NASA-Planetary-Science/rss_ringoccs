...
/*  Make sure the name CreateWhereFunction is available.                      */
#ifdef CreateWhereFunction
...
long **Where_Greater_##Type(type *data, long dim, threshtype threshold)\
{\
...
CreateWhereFunction(long long, Long_Long, double);
CreateWhereFunction(unsigned long long, ULong_Long, double);
CreateWhereFunction(float, Float, double);
CreateWhereFunction(double, Double, double);
CreateWhereFunction(long double, Long_Double, long double);

/*  Erase the CreateWhereFunction macro.                                      */
#undef CreateWhereFunction

#define CreateWhereFunction(type, Type, threshtype)\
long **Where_Lesser_##Type(type *data, long dim, threshtype threshold)\
{\
    /*  Declare necessary variables.                                         */\
    long i;\
    long arr_size = 0;\
