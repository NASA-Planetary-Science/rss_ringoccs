...
def calc_elevation_deg(et_vals, target, obs, kernels=None, verbose=False):
    """
    ...
    Args:
        ...
        target (str):         Target name -- must be compatible with NAIF.
        obs (str):            Observer name -- must be compatible with NAIF.
                                    Observer is assumed to be on Earth.
