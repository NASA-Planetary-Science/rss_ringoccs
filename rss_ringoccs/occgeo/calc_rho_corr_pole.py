...
def calc_rho_corr_pole(rho_km_vals_ori, et_vals, dsn, planet, spacecraft,
    ...
    Args:
        rho_km_vals_ori (np.ndarray): 
            Array of uncorrected ring radii in km.
        et_vals (np.ndarray): 
            Array of earth-received times in ET sec corresponding to 
            rho_km_vals_ori.
        dsn (str): 
        ...
        new_kernels (list):
            NAIF pck kernel with the improved pole.

    Output:
        rho_corr_km (np.ndarray): 
            Radius corrections in km to be added to the uncorrected radii.
    """
