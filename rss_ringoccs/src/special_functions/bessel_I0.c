...
float rssringoccs_Bessel_I0_Float(float x)
{
    ...
    else if (abs_x < MAX_FLOAT_BASE_E)
    {
        ...
        bessel_I0 *= rssringoccs_Exp_Float(abs_x) /
                     rssringoccs_Sqrt_Float(TWO_PI*abs_x);
    }
...
double rssringoccs_Bessel_I0_Double(double x)
{
    ...
    abs_x = rssringoccs_Abs_Double(x);
    ...
    else if (abs_x < MAX_DOUBLE_BASE_E)
    {
        ...
        bessel_I0 *= rssringoccs_Exp_Double(abs_x) /
                     rssringoccs_Sqrt_Double(TWO_PI*abs_x);
    }
...
long double rssringoccs_Bessel_I0_LongDouble(long double x)
{
    ...
    abs_x = rssringoccs_Abs_LongDouble(x);
    ...
    else if (abs_x < MAX_LDOUBLE_BASE_E)
    {
        ...
        bessel_I0 *= rssringoccs_Exp_LongDouble(abs_x) /
                     rssringoccs_Sqrt_LongDouble(TWO_PI*abs_x);
    }
...
rssringoccs_Bessel_I0_ComplexDouble(rssringoccs_ComplexDouble z)
{
    ...
    if (z_real == 0)
    {
        ...
        real_bessel = rssringoccs_Bessel_J0_Double(z_imag);
