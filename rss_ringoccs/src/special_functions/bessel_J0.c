...
float rssringoccs_Bessel_J0_Float(float x)
{
...
double rssringoccs_Bessel_J0_Double(double x)
{
    /*  Declare necessary variables. C89 requires declaring these at the top. */
...
long double rssringoccs_Bessel_J0_LongDouble(long double x)
{
    /*  Declare necessary variables. C89 requires declaring these at the top. */
    ...
    {
        /*  J_0 is an even function so use the absolute value of x.           */
        x = rssringoccs_Abs_LongDouble(x);
