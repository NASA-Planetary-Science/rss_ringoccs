...
float rssringoccs_Kaiser_Bessel_2_0_Float(float x, float W)
{
    float bessel_x, arg;
    arg = 2.0*x/W;
    arg = 1.0 - x*x;
...
double rssringoccs_Kaiser_Bessel_2_0_Double(double x, double W)
{
    double bessel_x, arg;
    arg = 2.0*x/W;
    arg = 1.0 - x*x;
...
long double
rssringoccs_Kaiser_Bessel_2_0_LongDouble(long double x, long double W)
{
