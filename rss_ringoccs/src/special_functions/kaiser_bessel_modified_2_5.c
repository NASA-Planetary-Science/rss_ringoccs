...
float rssringoccs_Modified_Kaiser_Bessel_2_5_Float(float x, float W)
{
    float bessel_x, arg;
    arg = 2.0*x/W;
    arg = 1.0 - x*x;
...
double rssringoccs_Modified_Kaiser_Bessel_2_5_Double(double x, double W)
{
    double bessel_x, arg;
    arg = 2.0*x/W;
    arg = 1.0 - x*x;
...
long double
rssringoccs_Modified_Kaiser_Bessel_2_5_LongDouble(long double x, long double W)
{
