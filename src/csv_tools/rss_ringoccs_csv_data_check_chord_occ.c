...
void rssringoccs_CSVData_Check_Chord_Occ(rssringoccs_CSVData *csv)
{
    ...
    if (!csv->geo)
    {
        ...
        csv->error_message =
            ...
            "\trssringoccs_CSVData_Check_Chord_Occ\n\n"
            "csv->geo is NULL.\n\n";
    ...
    if ((min_dr_dt < 0.0) && (max_dr_dt > 0.0))
    {
        ...
        csv->error_message =
            "\nError Encountered: rss_ringoccs\n"
            "\trssringoccs_CSVData_Check_Chord_Occ\n\n"
            "drho/dt has positive and negative values. Check your DLP file.\n"
            "It is likely a chord occultation and needs to be split into\n"
    ...
    if ((min_dr_dt == 0.0) || (max_dr_dt == 0.0))
    {
        ...
        csv->error_message =
            "\nError Encountered: rss_ringoccs\n"
            "\trssringoccs_CSVData_Check_Chord_Occ\n\n"
            "drho/dt has zero-valued elements. Check your DLP file.\n"
            "It is likely a chord occultation and needs to be split into\n"
            "ingress and egress portions.\n\n";
    ...
    if (max_dr_dt < 0.0)
    {
        rssringoccs_CSVData_Reverse_Geo_Variables(csv);
