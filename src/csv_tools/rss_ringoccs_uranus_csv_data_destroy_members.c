...
/*  rssringoccs_UranusCSVData typedef here, and function prototype given.     */
...
/*  Free's all members of a rssringoccs_UranusCSVData pointer except the       *
 *  error_message. Members are set to NULL after freeing.                     */
void rssringoccs_UranusCSVData_Destroy_Members(rssringoccs_UranusCSVData *csv)
{
    ...
    rssringoccs_UranusDLPCSV_Destroy(&(csv->dlp));
