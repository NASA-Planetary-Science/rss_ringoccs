...
def make_dlp_file(dlp_file_name, norm_diff_inst):
    ...
    if norm_diff_inst.end_of_chord_ing is None:
        ...
        np.savetxt(dlp_file_name,
            np.c_[norm_diff_inst.rho_km_vals, TEMP, TEMP,
                ...
                et_to_spm(norm_diff_inst.t_ret_et_vals),
                et_to_spm(norm_diff_inst.t_set_et_vals),
...
#                et_to_spm(norm_diff_inst.t_ret_et_vals[0:ind1]),
#                et_to_spm(norm_diff_inst.t_set_et_vals[0:ind1]),
