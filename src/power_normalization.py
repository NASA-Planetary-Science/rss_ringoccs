...
Revisions:
   ...
   Apr 04 2018 - gsteranka - In initial downsampling step before resample_poly,
   ...
   Apr 04 2018 - gsteranka - In loop to make knots_spm and knots_rho, change i
                             index to int(i)
   Apr 05 2018 - gsteranka - Added index sorting right before splrep to take
                             ingress files, since splrep expects x values to be
                             in order, which isn't true for ingress
   Apr 25 2018 - gsteranka - Added testing plot in get_spline_fit() method.
