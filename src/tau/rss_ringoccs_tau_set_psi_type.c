...
static const char rssringoccs_psi_type_error_message[2487];
...
static const char rssringoccs_psi_type_error_message[2487] = {
    'E', 'r', 'r', 'o', 'r', ' ', 'E', 'n', 'c', 'o', 'u', 'n', 't', 'e', 'r',
    'e', 'd', ':', ' ', 'r', 's', 's', '_', 'r', 'i', 'n', 'g', 'o', 'c', 'c',
    's', '\n', '\t', 'r', 's', 's', 'r', 'i', 'n', 'g', 'o', 'c', 'c', 's',
    '_', 'T', 'a', 'u', '_', 'S', 'e', 't', '_', 'P', 's', 'i', '_', 'T', 'y',
    'p', 'e', '\n', '\n', 'I', 'l', 'l', 'e', 'g', 'a', 'l', ' ', 's', 't',
    'r', 'i', 'n', 'g', ' ', 'f', 'o', 'r', ' ', 'p', 's', 'i', 't', 'y', 'p',
    'e', '.', ' ', 'A', 'l', 'l', 'o', 'w', 'e', 'd', ' ', 's', 't', 'r', 'i',
    'n', 'g', 's', ':', '\n', '\t', 'N', 'e', 'w', 't', 'o', 'n', ' ', 'R',
    'i', 'e', 'm', 'a', 'n', 'n', ':', '\n', '\t', '\t', 'N', 'e', 'w', 't',
    'o', 'n', '-', 'R', 'a', 'p', 'h', 's', 'o', 'n', ' ', 'm', 'e', 't', 'h',
    'o', 'd', ' ', 'u', 's', 'i', 'n', 'g', ' ', 'a', ' ', 'R', 'i', 'e', 'm',
    'a', 'n', 'n', ' ', 's', 'u', 'm', ' ', 'f', 'o', 'r', ' ', 't', 'h', 'e',
    ' ', 'i', 'n', 't', 'e', 'g', 'r', 'a', 'l', '.', '\n', '\t', '\t', 'T',
    'h', 'i', 's', ' ', 'i', 's', ' ', 'i', 'n', 'a', 'c', 'c', 'u', 'r', 'a',
    't', 'e', ' ', 'f', 'o', 'r', ' ', 'd', 'a', 't', 'a', ' ', 's', 'e', 't',
    's', ' ', 'w', 'h', 'e', 'r', 'e', ' ', 'd', ' ', 'p', 's', 'i', ' ', '/',
    ...
    'h', 'o', 'd', ' ', 'u', 's', 'i', 'n', 'g', ' ', 'a', ' ', 'm', 'o', 'd',
    'i', 'f', 'i', 'e', 'd', ' ', 'l', 'i', 'n', 'e', 'a', 'r', ' ', 'F', 'i',
    'l', 'o', 'n', ' ', 'q', 'u', 'a', 'd', 'r', 'a', 't', 'u', 'r', 'e', '\n',
    '\t', '\t', 'f', 'o', 'r', ' ', 't', 'h', 'e', ' ', 'i', 'n', 't', 'e',
    'g', 'r', 'a', 'l', '.', ' ', 'T', 'h', 'e', ' ', 'd', 'a', 't', 'a', ' ',
    '\'', 'T', '\'', ' ', 'i', 's', ' ', 'a', 's', 's', 'u', 'm', 'e', 'd',
    ' ', 'c', 'o', 'n', 's', 't', 'a', 'n', 't', ' ', 'a', 'c', 'r', 'o', 's',
    's', ' ', 'e', 'a', 'c', 'h', ' ', 'b', 'i', 'n', '\n', ' ', ' ', ' ',
    ' ', ' ', ' ', ' ', 'a', 'n', 'd', ' ', 't', 'h', 'e', ' ', 'F', 'r', 'e',
    's', 'n', 'e', 'l', ' ', 'p', 'h', 'a', 's', 'e', ' ', '\'', 'p', 's',
    'i', '\'', ' ', 'i', 's', ' ', 'f', 'i', 't', 't', 'e', 'd', ' ', 't',
    'o', ' ', 'a', ' ', 'l', 'i', 'n', 'e', ' ', 'p', 's', 'i', ' ', '=', ' ',
    'a', 'x', ' ', '+', ' ', 'b', '.', '\n', ' ', ' ', ' ', ' ', ' ', ' ',
    ' ', 'T', 'h', 'a', 't', ' ', 'i', 's', ',', ' ', 'T', ' ', 'u', 's', 'e',
    's', ' ', 'a', ' ', 'd', 'e', 'g', 'r', 'e', 'e', ' ', '0', ' ', 'a', 'p',
    'p', 'r', 'o', 'x', 'i', 'm', 'a', 't', 'i', 'o', 'n', ' ', 'a', 'n', 'd',
    ' ', 'p', 's', 'i', ' ', 'u', 's', 'e', 's', ' ', 'd', 'e', 'g', 'r', 'e',
    'e', ' ', '1', '.', '\n', '\t', 'N', 'e', 'w', 't', 'o', 'n', ' ', 'F',
    'i', 'l', 'o', 'n', ' ', '1', '1', ':', '\n', '\t', '\t', 'N', 'e', 'w',
    't', 'o', 'n', '-', 'R', 'a', 'p', 'h', 's', 'o', 'n', ' ', 'm', 'e', 't',
    'h', 'o', 'd', ' ', 'u', 's', 'i', 'n', 'g', ' ', 'a', ' ', 'm', 'o', 'd',
    ...
    'g', 'r', 'a', 'l', '.', ' ', 'T', 'h', 'e', ' ', 'd', 'a', 't', 'a', ' ',
    '\'', 'T', '\'', ' ', 'a', 'n', 'd', ' ', 't', 'h', 'e', ' ', 'F', 'r',
    'e', 's', 'n', 'e', 'l', ' ', 'p', 'h', 'a', 's', 'e', ' ', '\'', 'p',
    's', 'i', '\'', ' ', 'a', 'r', 'e', '\n', ' ', ' ', ' ', ' ', ' ', ' ',
    ' ', 'b', 'o', 't', 'h', ' ', 'a', 's', 's', 'u', 'm', 'e', 'd', ' ', 'l',
    'i', 'n', 'e', 'a', 'r', ' ', 'a', 'c', 'r', 'o', 's', 's', ' ', 'a', ' ',
    'b', 'i', 'n', ',', ' ', 'T', ' ', '=', ' ', 'a', 'x', ' ', '+', ' ', 'b',
    ',', ' ', 'p', 's', 'i', ' ', '=', ' ', 'c', 'x', ' ', '+', ' ', 'd', '.',
    '\n', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'T', 'h', 'a', 't', ' ', 'i',
    's', ',', ' ', 'T', ' ', 'u', 's', 'e', 's', ' ', 'a', ' ', 'd', 'e', 'g',
    'r', 'e', 'e', ' ', '1', ' ', 'a', 'p', 'p', 'r', 'o', 'x', 'i', 'm', 'a',
    't', 'i', 'o', 'n', ' ', 'a', 'n', 'd', ' ', 'p', 's', 'i', ' ', 'u', 's',
    'e', 's', ' ', 'd', 'e', 'g', 'r', 'e', 'e', ' ', '1', '.', '\n', '\t',
    'N', 'e', 'w', 't', 'o', 'n', ' ', 'P', 'e', 'r', 't', 'u', 'r', 'b', ':',
    '\n', '\t', '\t', 'S', 'a', 'm', 'e', ' ', 'a', 's', ' ', 'N', 'e', 'w',
    't', 'o', 'n', ' ', 'Q', 'u', 'a', 'd', 'r', 'a', 't', 'i', 'c', ' ', 'F',
    'i', 'l', 'o', 'n', ',', ' ', 'b', 'u', 't', ' ', 'a', 'n', ' ', 'a', 'r',
    'b', 'i', 't', 'r', 'a', 'r', 'y', ' ', 'q', 'u', 'a', 'r', 't', 'i', 'c',
    ' ', 'i', 's', '\n', '\t', '\t', 'a', 'l', 'l', 'o', 'w', 'e', 'd', ' ',
    'f', 'o', 'r', ' ', 'p', 'e', 'r', 't', 'u', 'r', 'b', 'i', 'n', 'g', ' ',
    't', 'h', 'e', ' ', 's', 't', 'a', 't', 'i', 'o', 'n', 'a', 'r', 'y', ' ',
    'F', 'r', 'e', 's', 'n', 'e', 'l', ' ', 'p', 'h', 'a', 's', 'e', ' ', '(',
    'p', 's', 'i', ')', '.', '\n', '\t', '\t', 'T', 'h', 'i', 's', ' ', 'm',
    'a', 'y', ' ', 'b', 'e', ' ', 's', 'e', 't', ' ', 'a', 't', ' ', 't', 'h',
    'e', ' ', 'p', 'y', 't', 'h', 'o', 'n', ' ', 'l', 'e', 'v', 'e', 'l', ' ',
    'u', 's', 'i', 'n', 'g', ' ', 't', 'h', 'e', ' ', 'p', 'e', 'r', 't', 'u',
    'r', 'b', ' ', 'k', 'e', 'y', 'w', 'o', 'r', 'd', '.', '\n', '\t', 'N',
    'e', 'w', 't', 'o', 'n', ' ', '4', ':', '\n', '\t', '\t', 'N', 'e', 'w',
    't', 'o', 'n', '-', 'R', 'a', 'p', 'h', 's', 'o', 'n', ' ', 'm', 'e', 't',
    ...
    '\n', '\t', '\t', 'q', 'u', 'a', 'r', 't', 'i', 'c', ' ', 'i', 'n', 't',
    'e', 'r', 'p', 'o', 'l', 'a', 't', 'i', 'o', 'n', ' ', 'o', 'f', ' ', 't',
    'h', 'e', ' ', 'F', 'r', 'e', 's', 'n', 'e', 'l', ' ', 'p', 'h', 'a', 's',
    'e', ' ', 'a', 'c', 'r', 'o', 's', 's', ' ', 't', 'h', 'e', ' ', 'w', 'i',
    'n', 'd', 'o', 'w', '.', '\n', '\t', 'N', 'e', 'w', 't', 'o', 'n', ' ',
    '8', ':', '\n', '\t', '\t', 'N', 'e', 'w', 't', 'o', 'n', '-', 'R', 'a',
    'p', 'h', 's', 'o', 'n', ' ', 'm', 'e', 't', 'h', 'o', 'd', ' ', 'u', 's',
    'i', 'n', 'g', ' ', 'a', ' ', 'q', 'u', 'a', 'd', 'r', 'a', 't', 'i', 'c',
    ' ', 'F', 'i', 'l', 'o', 'n', ' ', 'q', 'u', 'a', 'd', 'r', 'a', 't', 'u',
    'r', 'e', ' ', 'w', 'i', 't', 'h', ' ', 'a', 'n', '\n', '\t', '\t', 'o',
    'c', 't', 'i', 'c', ' ', 'i', 'n', 't', 'e', 'r', 'p', 'o', 'l', 'a', 't',
    'i', 'o', 'n', ' ', 'o', 'f', ' ', 't', 'h', 'e', ' ', 'F', 'r', 'e', 's',
    'n', 'e', 'l', ' ', 'p', 'h', 'a', 's', 'e', ' ', 'a', 'c', 'r', 'o', 's',
    's', ' ', 't', 'h', 'e', ' ', 'w', 'i', 'n', 'd', 'o', 'w', '.', '\n',
    '\t', 'N', 'e', 'w', 't', 'o', 'n', ' ', '1', '6', ':', '\n', '\t', '\t',
    'N', 'e', 'w', 't', 'o', 'n', '-', 'R', 'a', 'p', 'h', 's', 'o', 'n', ' ',
    'm', 'e', 't', 'h', 'o', 'd', ' ', 'u', 's', 'i', 'n', 'g', ' ', 'a', ' ',
    'q', 'u', 'a', 'd', 'r', 'a', 't', 'i', 'c', ' ', 'F', 'i', 'l', 'o', 'n',
    ' ', 'q', 'u', 'a', 'd', 'r', 'a', 't', 'u', 'r', 'e', ' ', 'w', 'i', 't',
    'h', ' ', 'a', '\n', '\t', '\t', 'h', 'e', 'x', 'a', 'd', 'e', 'c', 'i',
    'c', ' ', 'i', 'n', 't', 'e', 'r', 'p', 'o', 'l', 'a', 't', 'i', 'o', 'n',
    ' ', 'o', 'f', ' ', 't', 'h', 'e', ' ', 'F', 'r', 'e', 's', 'n', 'e', 'l',
    ' ', 'p', 'h', 'a', 's', 'e', ' ', 'a', 'c', 'r', 'o', 's', 's', ' ', 't',
    'h', 'e', ' ', 'w', 'i', 'n', 'd', 'o', 'w', '.', '\n', '\t', 'S', 'i',
    'm', 'p', 'l', 'e', ' ', 'F', 'F', 'T', ':', '\n', '\t', '\t', 'U', 's',
    'e', ' ', 'a', ' ', 's', 'i', 'n', 'g', 'l', 'e', ' ', 'F', 'F', 'T', ' ',
    'o', 'f', ' ', 't', 'h', 'e', ' ', 'e', 'n', 't', 'i', 'r', 'e', ' ', 'd',
    'a', 't', 'a', ' ', 's', 'e', 't', '.', ' ', 'T', 'h', 'i', 's', ' ', 'i',
    's', ' ', 'v', 'e', 'r', 'y', ' ', 'f', 'a', 's', 't', ',', ' ', 'b', 'u',
    't', '\n', '\t', '\t', 'i', 't', ' ', 'a', 's', 's', 'u', 'm', 'e', 's',
    ' ', 't', 'h', 'e', ' ', 'g', 'e', 'o', 'm', 'e', 't', 'r', 'y', ' ', 'i',
    's', ' ', 'n', 'e', 'a', 'r', 'l', 'y', ' ', 'c', 'o', 'n', 's', 't', 'a',
    'n', 't', ' ', 'f', 'o', 'r', ' ', 't', 'h', 'e', ' ', 'e', 'n', 't', 'i',
    'r', 'e', ' ', 'd', 'a', 't', 'a', '\n', '\t', '\t', 's', 'e', 't', '.',
    ' ', 'O', 'n', 'l', 'y', ' ', 'u', 's', 'e', ' ', 't', 'h', 'i', 's', ' ',
    'f', 'o', 'r', ' ', 's', 'm', 'a', 'l', 'l', ' ', 'r', 'a', 'n', 'g', 'e',
    's', ',', ' ', 'o', 'r', ' ', 's', 'e', 't', 's', ' ', 'w', 'i', 't', 'h',
    ' ', 's', 't', 'a', 'b', 'l', 'e', ' ', 'g', 'e', 'o', 'm', 'e', 't', 'r',
    'y', '.', '\n', '\t', 'E', 'l', 'l', 'i', 'p', 's', 'e', ':', '\n', '\t',
    ...
    'h', 'i', 's', ' ', 'i', 's', '\n', '\t', '\t', 'u', 's', 'e', 'f', 'u',
    'l', ' ', 'f', 'o', 'r', ' ', 'e', 'l', 'l', 'i', 'p', 't', 'i', 'c', 'a',
    'l', ' ', 'r', 'i', 'n', 'g', 's', '.', '\n', '\t', 'F', 'r', 'e', 's',
    'n', 'e', 'l', ':', '\n', '\t', '\t', 'C', 'l', 'a', 's', 's', 'i', 'c',
    ' ', 'q', 'u', 'a', 'd', 'r', 'a', 't', 'i', 'c', ' ', 'F', 'r', 'e', 's',
    'n', 'e', 'l', ' ', 'a', 'p', 'p', 'r', 'o', 'x', 'i', 'm', 'a', 't', 'i',
    'o', 'n', '.', ' ', 'T', 'h', 'i', 's', ' ', 'i', 's', ' ', 't', 'h', 'e',
    ' ', 'f', 'a', 's', 't', 'e', 's', 't', '\n', '\t', '\t', 'm', 'e', 't',
    'h', 'o', 'd', ',', ' ', 'b', 'u', 't', ' ', 'i', 't', ' ', 'i', 's', ' ',
    'n', 'o', 't', ' ', 'a', 'p', 'p', 'l', 'i', 'c', 'a', 'b', 'l', 'e', ' ',
    't', 'o', ' ', 'm', 'a', 'n', 'y', ' ', 'd', 'a', 't', 'a', ' ', 's', 'e',
    't', 's', '.', '\n', '\t', '\t', 'R', 'e', 'v', '0', '0', '7', ' ', 'f',
    'r', 'o', 'm', ' ', 'C', 'a', 's', 's', 'i', 'n', 'i', ' ', 'a', 'n', 'd',
    ' ', 't', 'h', 'e', ' ', 'V', 'o', 'y', 'a', 'g', 'e', 'r', ' ', '2', ' ',
    'U', 'r', 'a', 'n', 'u', 's', ' ', 'd', 'a', 't', 'a', ' ', 'a', 'r', 'e',
    ' ', 'e', 'x', 'a', 'm', 'p', 'l', 'e', 's', '\n', '\t', '\t', 'o', 'f',
    ' ', 'i', 'd', 'e', 'a', 'l', ' ', 's', 'e', 't', 's', '.', ' ', 'F', 'o',
    'r', ' ', 'C', 'a', 's', 's', 'i', 'n', 'i', '\'', 's', ' ', 'R', 'e',
    'v', '1', '3', '3', ' ', 't', 'h', 'i', 's', ' ', 'm', 'e', 't', 'h', 'o',
    'd', ' ', 'i', 's', ' ', 'u', 'n', 'u', 's', 'a', 'b', 'l', 'e', '.', '\n',
    '\t', 'F', 'r', 'e', 's', 'n', 'e', 'l', ' ', 'n', ':', '\n', '\t', '\t',
    'L', 'e', 'g', 'e', 'n', 'd', 'r', 'e', ' ', 'p', 'o', 'l', 'y', 'n', 'o',
    'm', 'i', 'a', 'l', ' ', 'a', 'p', 'p', 'r', 'o', 'x', 'i', 'm', 'a', 't',
    'i', 'o', 'n', ' ', 'w', 'i', 't', 'h', ' ', '3', ' ', '<', ' ', 'n', ' ',
    '<', ' ', '2', '5', '6', '.', ' ', 'L', 'i', 'k', 'e', ' ', 't', 'h', 'e',
    '\n', '\t', '\t', 'F', 'r', 'e', 's', 'n', 'e', 'l', ' ', 'm', 'e', 't',
    'h', 'o', 'd', ',', ' ', 't', 'h', 'i', 's', ' ', 'i', 's', ' ', 'o', 'n',
    'l', 'y', ' ', 'a', 'p', 'p', 'l', 'i', 'c', 'a', 'b', 'l', 'e', ' ', 't',
    'o', ' ', 'c', 'e', 'r', 't', 'a', 'i', 'n', ' ', 'd', 'a', 't', 'a', ' ',
    's', 'e', 't', 's', '.', '\n', '\t', '\t', 'U', 's', 'e', ' ', 't', 'h',
    'i', 's', ' ', 'w', 'h', 'e', 'n', ' ', 't', 'h', 'e', ' ', 'o', 'p', 'e',
    'n', 'i', 'n', 'g', ' ', 'a', 'n', 'g', 'l', 'e', ' ', 'i', 's', ' ', 'l',
    'a', 'r', 'g', 'e', '.', ' ', 'I', 't', ' ', 'i', 's', ' ', 'n', 'e', 'a',
    'r', 'l', 'y', ' ', 'a', 's', ' ', 'f', 'a', 's', 't', ' ', 'a', 's', '\n',
    '\t', '\t', 't', 'h', 'e', ' ', 'F', 'r', 'e', 's', 'n', 'e', 'l', ' ',
    'm', 'e', 't', 'h', 'o', 'd', ',', ' ', 'b', 'u', 't', ' ', 'm', 'o', 'r',
    'e', ' ', 'a', 'c', 'c', 'u', 'r', 'a', 't', 'e', ' ', 'w', 'h', 'e', 'n',
    ' ', 'i', 't', ' ', 'i', 's', ' ', 'a', 'p', 'p', 'l', 'i', 'c', 'a', 'b',
    'l', 'e', '.', '\n', '\n', 'N', 'o', 't', 'e', ':', '\n', '\t', 'I', 'n',
    'p', 'u', 't', ' ', 's', 't', 'r', 'i', 'n', 'g', 's', ' ', 'a', 'r', 'e',
    ' ', 'n', 'e', 'i', 't', 'h', 'e', 'r', ' ', 'c', 'a', 's', 'e', ' ', 'n',
    'o', 'r', ' ', 's', 'p', 'a', 'c', 'e', ' ', 's', 'e', 'n', 's', 'i', 't',
    'i', 'v', 'e', '.', ' ', 'Y', 'o', 'u', ' ', 'm', 'a', 'y', ' ', 'a', 'd',
    'd', '\n', '\t', 'o', 'r', ' ', 'r', 'e', 'm', 'o', 'v', 'e', ' ', 's',
    'p', 'a', 'c', 'e', 's', ',', ' ', 'a', 'n', 'd', ' ', 'u', 's', 'e', ' ',
    'u', 'p', 'p', 'e', 'r', ' ', 'c', 'a', 's', 'e', ' ', 'o', 'r', ' ', 'l',
    'o', 'w', 'e', 'r', ' ', 'c', 'a', 's', 'e', ' ', 'l', 'e', 't', 't', 'e',
    'r', 's', '.', '\n', '\0'
};
