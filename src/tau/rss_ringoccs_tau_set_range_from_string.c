 ...
 *  success it changes the values range points to and then returns 1. On      *
                                      ...
                                      rssringoccs_TAUObj *tau)
{
    ...
    {
        tau->range[0] = 118550.0;
        tau->range[1] = 118660.0;
    }
