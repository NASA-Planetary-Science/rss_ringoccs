...
int main(void)
{
    ...
    rss_fp = fopen("rss_bessel_i0_binary", "w");
    ...
    for (n=0; n<N; ++n)
    {
        y0 = rssringoccs_Double_Bessel_I0(x);
    ...
    system("graph -T ps -I d < rss_bessel_i0_binary gsl_bessel_i0_binary "
           "-L \"Bessel I0\" --reposition 0.0 -0.8 1 diff_binary "
           "-L \"Difference (rss_ringoccs vs gsl)\" > bessel_I0.ps");
    system("rm -f rss_bessel_i0_binary gsl_bessel_i0_binary diff_binary");
    return 0;
}
